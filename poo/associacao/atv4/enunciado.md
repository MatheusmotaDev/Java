 Modelo de dados para um cadastro de
clientes.
...
 Cliente: nome, rg, cpf, telefone, data de
nascimento e endereço.


 Endereço: nome do logradouro, número, bairro,
cidade e estado.
...
 Considerar construtor default e construtor com
